...
Let's start make our own functions.

### Hack Time!
```{r eval=FALSE}
# Let's create a function that prints our first and last name.
...
# To go further
- The [Base R](http://github.com/rstudio/cheatsheets/raw/master/base-r.pdf) cheatsheet
