...
Your journey has been long! Let's recap what you have achieved so far:
- You have learned programming basics.
- You have learned how to explore and visualise real world data.
- You have learned how to manage and clean data.
- You have learned to combine prose and code into reproducible working documents.
- You have learned how to aggregate and summarise data into useful pieces of information (more on this today).

You might not be yet fluent in R, but you can read code and adjust it to suit your needs. Now, it is time to start to answering questions using data.
Remember that getting familiar with the data and fixing all its problems takes easily 80% or more of a researcher's time. Once your data is ready, the analysis or the modeling part is usually very quick!

Once we know more about our dataset, it is time to more fix the identified flaws in the data and begin to extract useful insights.


# Hack Time! - Answering questions with data!
